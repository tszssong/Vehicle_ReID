...
from DataIter import PersonReID_Proxy_Batch_Plate_Mxnet_Iter2_NSoftmax  
...
def Do_Proxy_NCA_Train3():
  print 'Partial Normalized Softmax Training..PERSON.'
...
#  proxy_num = 4035
  ...
  label_shape = dict(zip(['proxy_yM'], [proxy_yM_shape]))
  proxyfn = 'proxy.bin'
...
#  datafn_list = ['/list_dir/Person_train.list']#['front_plate_image_list_train.list'] #261708 calss number.
  datafn_list = ['/list_dir/Person_train.list'] #51477
...
#  datafn_list = ['data_each_part6.list', 'data_each_part7.list'] #142149 calss number.
  ...
  data_train = PersonReID_Proxy_Batch_Plate_Mxnet_Iter2_NSoftmax(['data'], [data_shape], ['proxy_yM'], [proxy_yM_shape], datafn_list, total_proxy_num, featdim, proxy_batch, proxy_num, 1)
